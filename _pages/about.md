...
<section class="rail">
  ...
  <div class="rail__body">
    <p class="lede">My research focuses on <strong>data-centric deep learning methods</strong>, particularly self-supervised and active learning approaches. I work at the intersection of machine learning and bioacoustics, developing foundation models and large-scale benchmarks that advance both fields.</p>

    <dl class="deflist">
      <div class="defrow">
        <dt>Self-Supervised Learning</dt>
        <dd>Audio representation learning — masked autoencoders and probing methods for multi-label classification.</dd>
      </div>
      <div class="defrow">
        <dt>Active Learning</dt>
        <dd>Human-in-the-loop deep learning: query strategies, embedding quality, and label-efficient training.</dd>
      </div>
      <div class="defrow">
        <dt>Bioacoustics</dt>
        <dd>Foundation models and large-scale benchmarks that make avian bioacoustics a frontier domain for deep learning.</dd>
      </div>
    </dl>
